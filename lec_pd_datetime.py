...
#prc.loc.py[:, 'Date'] = pd.to_datetime(prc['Date'], format='%Y-%m-%d')
#prc.info() 
...
#print(prc.loc.py['2020'])
#
## Select all data for a given month
#print(prc.loc.py['2020-01'])
#
## Selecting date ranges using strings
#print(prc.loc.py['2020-01-01':'2020-01-05'])
#
#
...
# compute returns
#rets = prc.loc.py[:, 'Close'].pct_change()
#print(rets)  
